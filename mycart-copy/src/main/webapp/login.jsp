					...
					<div class="card-body">
						...
						<form action="LoginServlet" method="post">
							...
							<a href="register.jsp" class="text-center d-block mb-2"> if
								not registered click here </a> <a href="loginWithOTP.jsp"
								class="text-center d-block mb-2"> Forgot password? </a>
							<div class="container text-center">

								<button type="submit"
									class="btn btn-primary border-0 custom-bg ">Submit</button>
								<button type="" class="btn btn-primary custom-bg border-0 ">Reset</button>
							</div>
